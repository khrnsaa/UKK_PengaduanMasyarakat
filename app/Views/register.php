...
<body class="img js-fullheight" style="background-image: url(/images/bg-rqs.jpg);">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">From Registrasi Aplikasi Pengaduan Masyarakat Desa Gereba</h2>
				</div>
			</div>
			<div class="row justify-content-center">
					...
					<div class="login-wrap p-0">
		      		<form action="/masyarakat/daftar" method="POST" class="signup-form">
                		...
                		<div class="form-group">
		      				<input name="txtNik" type="number" class="form-control" placeholder="NIK" required>
                    	</div>
						<div class="form-group">
						...
						<div class="form-group">
		      				<input name="txtTelp" type="number" class="form-control" placeholder="Nomor Telepon" required>
		      			</div>
	            		<div class="form-group">
