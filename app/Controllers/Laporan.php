...
class Laporan extends BaseController
{
	...
	public function pengaduanTampil(){
		...
		$arrBulan=[1=>'Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','November','Desember'];
		...
		$htmlData .='<p>
		<button href"/print" onclick="window.print()" class="btn btn-primary btn-sm mr-2"<i class="fa fa-print"></i>Print</button>
		</p>';			
		echo $htmlData;	
